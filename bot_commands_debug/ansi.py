...
@plugin.include
@crescent.command(name="ansi")
async def test_ansi_color(ctx: crescent.Context) -> None:
    log = "```ansi\n"
    # log += FormatText.error('Bold Red')
...
async def test(ctx: crescent.Context) -> None:
    ...
    embed.add_field(name="Breakdown 1", value=f"\u200b\u2001\u2001[**2**]({link})\u2001*out of*\u200120")
    embed.add_field(name="Breakdown 2", value=f"\u200b\u2001\u2001[**8**]({link})\u2001*out of*\u200130")
